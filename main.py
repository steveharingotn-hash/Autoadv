...
class ReplicaControlPanel(discord.ui.View):
    ...
    async def slot1(self, interaction: discord.Interaction, button: discord.ui.Button):
        await interaction.response.send_message("Use **Setup** button to configure Slot 1", ephemeral=True)
...
class SetupModal(discord.ui.Modal, title="Setup Slot 1"):
    ...
    async def on_submit(self, interaction: discord.Interaction):
        try:
            ...
            if delay < 5:
                return await interaction.response.send_message("❌ Minimum 5 seconds delay!", ephemeral=True)
        except:
        ...
        save_slots()
        await interaction.response.send_message("✅ Slot 1 Saved! Click **Start** to begin advertising.", ephemeral=True)
...
async def panel(interaction: discord.Interaction):
    try:
        ...
        await interaction.response.send_message("Error loading panel. Try again.", ephemeral=True)
